...
import com.mytiktok.app.activitesfragments.livestreaming.adapter.LiveUserAdapter;
...
public class LiveUsersA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    private void joinSingleStream() {
        ...
        intent.putExtra(com.mytiktok.app.activitesfragments.livestreaming.Constants.KEY_CLIENT_ROLE, io.agora.rtc.Constants.CLIENT_ROLE_AUDIENCE);
