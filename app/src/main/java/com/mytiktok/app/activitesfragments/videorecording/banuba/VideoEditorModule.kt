package com.wmocca.com.activitesfragments.videorecording.banuba
...
private class SampleIntegrationKoinModule {
    ...
    val module = module {
        ...
        single<CameraConfig> {
            CameraConfig(
                maxRecordedTotalVideoDurationMs = 60000,
                isSaveLastCameraFacing = true,
                isStartFrontFacingFirst = true,
                minRecordedTotalVideoDurationMs = 5000,
                supportsFlashlight = true,
                videoDurations= listOf(15000,30000,60000))
        }
        /**
        ...
        single<EditorConfig> {
            EditorConfig(
                minTotalVideoDurationMs = 5000,
                stickersApiKey = "OJsdxdu1JNNUq99op6s4X8uRYSdaTEtO"
            )
        }
